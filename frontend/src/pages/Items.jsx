							...
							<Grid item key={item.id} {...gridCols}>
								<Card sx={{ height: "100%", display: "flex", flexDirection: "column" }}>
									...
									<CardActions sx={{ justifyContent: "space-between" }}>
										{editingId === item.id ? (
											<>
												<Button startIcon={<SaveIcon />} onClick={() => onSaveEdit(item.id)} variant="contained" size="small">Save</Button>
												<Button startIcon={<CancelIcon />} onClick={onCancelEdit} color="inherit" size="small">Cancel</Button>
											</>
										) : (
											<>
